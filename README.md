...
iRB-Lab's [repository](https://github.com/iRB-Lab/py-ga-VRPTW)
...
```
## Contents for VRPMV
- [Modifications to the GA Implementation](#ga-implementation-mods)
    - Selection: Elite Selection
    - Partially Matched Crossover Method
    - Multiprocessing
- [GA Implementation of Movement Synchronization](#ga-implmentation-mv)
    - Individual with MV
        - Decode Individual with MV
        - Create Individuals with MV
    - [Evaluation of Individual with MV](#eval-mv)
